...
public class Enemigo2DistanciaScript : MonoBehaviour
{
    public int vida = 10;
    ...
    [Header("Armas")]
    [SerializeField] GameObject objetoVolador;
    ...
    void Update()
    {
        ...
        if (distanceToPlayer < 7f && distanceToPlayer > 6.5f)
        {
    ...
    {
        //Lanzar Mierda
        Instantiate(objetoVolador, transform.position, Quaternion.identity);
